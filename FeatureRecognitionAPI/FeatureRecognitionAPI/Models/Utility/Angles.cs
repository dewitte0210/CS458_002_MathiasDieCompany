...
public static class Angles
{
    ...
    public class Radians(double value)
    {
        ...
        {
            return new Radians((2 * Math.PI) - _value);
        }

        public Degrees ToDegrees()
        {
            return new Degrees(_value * 180 / Math.PI);
        }
        ...
        public override bool Equals(object? obj)
        {
            ...
            {
                return DoubleEquals(objR, _value, AngleTolRad);
            }
            return false;
        }

        public static implicit operator double(Radians r) => r._value;
    ...
    /// </summary>
    private static double CrossProduct(Line a, Line b)
    {
    ...
    /// </summary>
    private static double DotProduct(Line a, Line b)
    {
        Point aDelta = a.GetDelta();
        Point bDelta = b.GetDelta();
    ...
    public static Angle GetAngle(Line a, Line b, Side targetSide = Side.Interior,
        Orientation ori = Orientation.Counter)
    {
        ...
        side = cross >= 0 ? Side.Interior : Side.Exterior;
        if (cross < 0)
        {
            angle = 360 - angle;
        }
